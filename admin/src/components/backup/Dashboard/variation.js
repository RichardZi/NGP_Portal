...
export default class CRMDashboard1 extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://127.0.0.1:8000/apiViewSet/tasks/`)
        .then(res => {
            console.log(res.data);
            this.setState({
                    ...
                    <Row>
                        <Col md="12">
                            <Card className="main-card mb-3">
                                ...
                                <Table id="instances" responsive hover striped borderless className="align-middle mb-0">
                                    <thead>
                                    <tr>
                                        <th>UUID</th>
                                        <th>State</th>
                            ...
                            <Card className="main-card mb-3">
                                ...
                                <Table id="jobs" responsive hover striped borderless className="align-middle mb-0">
                                    ...
                                    {this.state.jobsList.map(( listValue, index ) => {
                                        return (
                                            <tr key={index} id={"Tooltip-job-" + listValue.id}>
                                                <td style={{cursor:"pointer"}}
                                                    onClick={() =>
                                                ...
                                                <UncontrolledTooltip placement="left" target={"Tooltip-job-" + listValue.id}>
                                                    <div className="row">
                                                        <div className="col-6">
                            ...
                            <Card className="main-card mb-3">
                                ...
                                <Table id="tasks" responsive hover striped borderless className="align-middle mb-0">
                                    ...
                                    {this.state.tasksList.map(( listValue, index ) => {
                                        return (
                                            <tr key={index} id={"Tooltip-task-" + listValue.id}>
                                                <td style={{cursor:"pointer"}}
                                                    onClick={() =>
                                                    window.open("/task/details/" + listValue.id, "_self")
                                                    }>{listValue.displayName}</td>
                                                <td>{listValue.id}</td>
                                                <td>{listValue.type}</td>
                                                <td>{listValue.status}</td>
                                                <td>{listValue.progress}</td>
                                                <UncontrolledTooltip placement="left" target={"Tooltip-task-" + listValue.id}>
                                                    <div className="row">
                                                        <div className="col-6">
                                                        <span>Current Step</span>
                                                        </div>
